class ProductsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @product.save
        format.html { redirect_to product_admin_path(@admin), notice: "Product was successfully created." }
  ...
  def update
    ...
    respond_to do |format|
      if @product.update(product_params)
        format.html { redirect_to product_admin_path(@admin), notice: "Product was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to product_admin_path(@admin), notice: "Product was successfully destroyed." }
