...
cps00 = CategoryProductsubtype.create!(name: 'electrical equipments & supplies', code_name: 'p_subtype_electrical_equip_supplies', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'construction materials', code_name: 'p_subtype_construction_materials', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'hardware', code_name: 'p_subtype_hardware', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'kitchen fixtures', code_name: 'p_subtype_kitchen_fixtures', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'plumbing', code_name: 'p_subtype_plumbing', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'painting supplies & wall treatments', code_name: 'p_subtype_painting_supplies', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'family intelligence system', code_name: 'p_subtype_family_intelligence', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'lights & lighting', code_name: 'p_subtype_lights', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'doors, gates & windows', code_name: 'p_subtype_doors_fates_windows', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'bathroom fixtures', code_name: 'p_subtype_bathroom_fixtures', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'power electric tools', code_name: 'p_subtype_power_electric_tools', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'welding & soldering supplies', code_name: 'p_subtype_welding_supplies', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'insulation', code_name: 'p_subtype_insulation', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'woodworking machinery & parts', code_name: 'p_subtype_woodworking_machinery ', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'welding equipment', code_name: 'p_subtype_welding_equipment', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'measurement & analysis tools', code_name: 'p_subtype_measurement_analysis_tools', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'abrasives', code_name: 'p_subtype_abrasives', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'abrasive tools', code_name: 'p_subtype_abrasives_tool', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'riveter guns', code_name: 'p_subtype_riveter_guns', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'hand & power tool accessories', code_name: 'p_subtype_hand_power_tool_accessories', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'lifting tools & accessories', code_name: 'p_subtype_lifting_tools_accessories', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'hand tools & parts', code_name: 'p_subtype_hand_tools_parts', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'construction tools', code_name: 'p_subtype_construction_tools', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'tool set', code_name: 'p_subtype_tool_set', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'tool organisation', code_name: 'p_subtype_tool_organisation', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'machine tools & accessories', code_name: 'p_subtype_machine_tools_accessories', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'heating, venting & cooling', code_name: 'p_subtype_heating_venting_cooling', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'prefabricated buildings', code_name: 'p_subtype_prefabricated_buildings', category_productitemtype_id: 23, admin_id: 1)
cps00 = CategoryProductsubtype.create!(name: 'construction & building machinery', code_name: 'p_subtype_construction_building_machinery', category_productitemtype_id: 23, admin_id: 1)
